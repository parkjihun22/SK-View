  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://www.spod.co.kr/ComplexGuide/detailintro"
        />
        ...
        <meta
          property="og:url"
          content="https://www.spod.co.kr/ComplexGuide/detailintro"
        />
        ...
        <script type="application/ld+json">
          {`
			...
			"url": "https://www.spod.co.kr/ComplexGuide/detailintro"
					}
					`}
        </script>
      </Helmet>
