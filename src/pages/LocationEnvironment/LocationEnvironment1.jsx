...
const LocationSection = [
  ...
  },
  {
    img: section2Image4,
    titleText:
      "천안8경 성성호수공원 그 개발의 최중심에서 만나는 <br />최고 39층에서 만나는 탁 트인 호수공원 조망",
    contentText:
      "성성호수공원 바로 앞, 도심 속에서 누리는 쾌적한 자연환경<br />이마트, 코스트코 , CGV 등 편의시설 인접",
  },
  {
    img: section2Image5,
    titleText: "e편한세상만의 혁신으로 완성된 <br />천안 프리미엄 주거의 기준",
    contentText:
      "라이프스타일 맞춤 플랫폼 C2 House 혁신설계 적용으로 효율적인 수납 및 디자인 차별화<br /> e편한세상의 특화 조경브랜드 ‘드포엠’으로 누리는 단지 내 그리너리 라이프",
  },
  {
    img: section2Image6,
    titleText:
    ...
    contentText:
      " 브레인시티 대장입지 <br />현대건설 프리미엄에 더한 슬세권 프리미엄",
  },
];
  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        />
        <link rel="canonical" href="https://www.ssanghwa.co.kr/LocationEnvironment/intro" />

        {/* Open Graph - 소셜 미디어 공유 최적화 */}
        <meta
          property="og:title"
          content="문화자이 SKVIEW - 입지안내"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.ssanghwa.co.kr/LocationEnvironment/intro"
        />
        ...
        <script type="application/ld+json">
          {`
			 ...
			 "url": "https://www.ssanghwa.co.kr/LocationEnvironment/intro"
				 }
				 `}
        </script>
      </Helmet>
      ...
      <p className={styles.screenReaderOnly}>
        문화자이 SKVIEW의 입지 안내 페이지는 이 단지의 위치와 주변 인프라에
      ...
      <div className={styles.textBox}>
        <div>갈수록 완벽해질 문화자이 SKVIEW</div>
        <div>살수록 높아질 문화자이 SKVIEW</div>
        <div>도시를 압도할 자부심 문화자이 SKVIEW </div>
      </div>

      <img
        src={page1}
        className={styles.image2}
        alt="문화자이 SKVIEW입지안내-image1"
      />
