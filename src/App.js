...
import FloorPlan9 from './pages/FloorPlan/FloorPlan9';
import FloorPlan10 from './pages/FloorPlan/FloorPlan10';
  ...
  return (
    <BrowserRouter>
        <Routes>
          ...
          <Route path="/FloorPlan/114D" element={<FloorPlan8 />} />
          <Route path="/FloorPlan/114E" element={<FloorPlan9 />} />
          <Route path="/FloorPlan/114F" element={<FloorPlan10 />} />
