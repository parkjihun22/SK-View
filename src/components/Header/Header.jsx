...
const menuArray = [
  ...
  },
  {
    title: "세대안내",
    subMenu: [
      { subTitle: "52㎡", subUrl: "/FloorPlan/59A" },
      { subTitle: "59㎡A", subUrl: "/FloorPlan/59B" },
      { subTitle: "59㎡B", subUrl: "/FloorPlan/84A" },
      { subTitle: "75㎡A", subUrl: "/FloorPlan/84B" },
      { subTitle: "75㎡B", subUrl: "/FloorPlan/114A" },
      { subTitle: "84㎡A1", subUrl: "/FloorPlan/114B" },
      { subTitle: "84㎡A2", subUrl: "/FloorPlan/114C" },
      { subTitle: "84㎡B", subUrl: "/FloorPlan/114D" },
      { subTitle: "84㎡C", subUrl: "/FloorPlan/114E" },
      { subTitle: "84㎡D", subUrl: "/FloorPlan/114F" },
    ],
  },
  {
    title: "인테리어",
      ...
      <>
        ...
        <div className={styles.mobileHeader}>
          <div onClick={() => setIsMobileMenu(!isMobileMenu)}>
            {!isMobileMenu ? (
              <AiOutlineMenu className={styles.icon} size={25} color="#0f0f1d" />
            ) : (
              <IoCloseSharp className={styles.icon} size={25} color="#0f0f1d" />
            )}
          </div>
          {isMobileMenu && (
            <SlideMenu
          ...
          <a href="tel:1533-8848">
            <IoCall className={styles.icon} size={25} color="#0f0f1d" />
          </a>
        </div>
